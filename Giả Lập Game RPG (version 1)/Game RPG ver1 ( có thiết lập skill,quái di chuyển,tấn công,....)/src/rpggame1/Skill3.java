...
public class Skill3 {
    ...
    public static boolean atking3; // bấm nút tấn công
    int mana = 0;
    int delta;
    int vector;
    public Skill3(){
    ...
    public void Akting(){
        for(int i = 0;i<mon1.size();i++){
            if(getBound((int) p.x - 12 - 48 + map.xMap,
                        ...
                        mon1.get(i).hp -= 10;
                        MonAtking = i;    
                        mon1.get(i).frozen = true;
                        mon1.get(i).deltafrozen = System.currentTimeMillis();
                        ////// setting
